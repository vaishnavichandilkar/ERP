    ...
    return (
        <div className="flex-1 w-full bg-[#ffffff] min-h-screen">
            <div className="p-6 md:p-8 max-w-[1600px] mx-auto w-full">
                {/* Header Section */}
                <div className="mb-8">
                    <h1 className="text-[22px] font-bold text-[#111827] mb-1.5 tracking-tight">Update Facility</h1>
                    <p className="text-[14px] text-gray-500">
                        Update facility by entering the required information below.
                    </p>
                </div>
                ...
                <div className="bg-white rounded-[12px] border border-[#e5e7eb] shadow-[0_1px_3px_rgb(0,0,0,0.05)] w-full">
                    <div className="px-6 py-4 border-b border-[#e5e7eb]">
                        <h2 className="text-[16px] font-semibold text-gray-900">Update Facility</h2>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                            ...
                            <div className="flex flex-col gap-1.5">
                                ...
                                <input
                                    ...
                                    className="px-3.5 py-2.5 bg-white border border-[#e5e7eb] rounded-lg text-[14px] focus:outline-none focus:ring-1 focus:ring-[#014A36] focus:border-[#014A36] text-gray-500 placeholder:text-gray-400"
                                />
                            </div>
