                        ...
                        <thead className="bg-[#FCFCFD] border-b border-[#E5E7EB] text-[#6B7280]">
                            <tr>
                                <th className="px-5 py-4 font-semibold">
                                    <div className="flex items-center gap-1 cursor-pointer">Vendor Code <ChevronsUpDown size={14} className="text-gray-400"/></div>
                                </th>
                                <th className="px-5 py-4 font-semibold">
                                    <div className="flex items-center gap-1 cursor-pointer">Account <ChevronsUpDown size={14} className="text-gray-400"/></div>
                                </th>
                                <th className="px-5 py-4 font-semibold">
                                    <div className="flex items-center gap-1 cursor-pointer">Group Name <ChevronsUpDown size={14} className="text-gray-400"/></div>
                                </th>
                                <th className="px-5 py-4 font-semibold">
                                    <div className="flex items-center gap-1 cursor-pointer">Credit Days <ChevronsUpDown size={14} className="text-gray-400"/></div>
                                </th>
                                <th className="px-5 py-4 font-semibold">
                                    <div className="flex items-center gap-1 cursor-pointer">GST.No <ChevronsUpDown size={14} className="text-gray-400"/></div>
                                </th>
                                <th className="px-5 py-4 font-semibold">
                                    <div className="flex items-center gap-1 cursor-pointer">PAN.No <ChevronsUpDown size={14} className="text-gray-400"/></div>
                                </th>
                                <th className="px-5 py-4 font-semibold">
                                    <div className="flex items-center gap-1 cursor-pointer">OP.Balance <ChevronsUpDown size={14} className="text-gray-400"/></div>
                                </th>
                                <th className="px-5 py-4 font-semibold">
                                    <div className="flex items-center gap-1 cursor-pointer">Address <ChevronsUpDown size={14} className="text-gray-400"/></div>
                                </th>
                                <th className="px-5 py-4 font-semibold">
                                    <div className="flex items-center gap-1 cursor-pointer">Bank Account.No <ChevronsUpDown size={14} className="text-gray-400"/></div>
                                </th>
                                <th className="px-5 py-4 font-semibold">
                                    <div className="flex items-center gap-1 cursor-pointer">IFSC Code <ChevronsUpDown size={14} className="text-gray-400"/></div>
                                </th>
                                <th className="px-5 py-4 font-semibold">
                                    <div className="flex items-center gap-1 cursor-pointer">Status <ChevronsUpDown size={14} className="text-gray-400"/></div>
                                </th>
                ...
                >
                    ...
                    <div className="relative w-[400px] max-w-full bg-white h-full flex flex-col animate-in slide-in-from-right duration-300 shadow-2xl">
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-[#E5E7EB]">
                            <h2 className="text-[18px] font-bold text-[#111827] font-['Plus_Jakarta_Sans']">Apply Filters</h2>
                        ...
                        <div className="flex-1 overflow-y-auto p-6 space-y-5">
                            <div>
                                <label className="block text-[13px] font-medium text-[#374151] mb-2">GST.No</label>
                                <input
                                    type="text"
                                    name="gstNo"
