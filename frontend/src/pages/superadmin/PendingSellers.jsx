                    ...
                    <table className="w-full text-left border-collapse">
                        <thead className="bg-emerald-900 border-b border-emerald-950 sticky top-0 z-10 shadow-[0_1px_0_0_rgba(6,78,59,0.5)] text-white">
                            <tr>
                                ...
                                <th className="px-6 py-4 text-xs font-semibold text-white uppercase tracking-wider border-r border-white/50 last:border-r-0">Status</th>
                                <th className="px-6 py-4 text-xs font-semibold text-white uppercase tracking-wider">Actions</th>
                            </tr>
                        </thead>
