...
-- CreateTable
CREATE TABLE "gst_uqc_master" (
    "id" SERIAL NOT NULL,
    "quantity" TEXT,
    "quantityType" TEXT,
    "uqcCode" TEXT NOT NULL,

    CONSTRAINT "gst_uqc_master_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "gst_uqc_master_uqcCode_key" ON "gst_uqc_master"("uqcCode");
...
-- AddForeignKey
ALTER TABLE "unit_master" ADD CONSTRAINT "unit_master_gstUom_fkey" FOREIGN KEY ("gstUom") REFERENCES "gst_uqc_master"("uqcCode") ON DELETE RESTRICT ON UPDATE CASCADE;
